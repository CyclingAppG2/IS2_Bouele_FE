...
import { ORGANIZATION_FALLBACK_PAGE_URI, VOLUNTEER_FALLBACK_PAGE_URI, ADMINISTRATOR_FALLBACK_PAGE_URI } from '../../_guards/tokens';
...
@NgModule({
    ...
    providers: [
      ...
      { provide: VOLUNTEER_FALLBACK_PAGE_URI, useValue: '/voluntary-home' },
