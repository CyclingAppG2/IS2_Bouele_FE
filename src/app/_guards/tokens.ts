...
export const VOLUNTARY_FALLBACK_PAGE_URI = new InjectionToken('VOLUNTARY_FALLBACK_PAGE_URI');
export const ORGANIZATION_FALLBACK_PAGE_URI = new InjectionToken('ORGANIZATION_FALLBACK_PAGE_URI');
export const UNCOMPLETED_FALLBACK_PAGE_URI = new InjectionToken('UNCOMPLETED_FALLBACK_PAGE_URI');
