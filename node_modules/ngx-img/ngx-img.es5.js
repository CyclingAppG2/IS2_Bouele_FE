...
import { Component, EventEmitter, Injectable, Input, NgModule, Output, ViewChild, ViewEncapsulation } from '@angular/core';
...
var NgxImgComponent = /** @class */ (function () {
     ...
     * @param {?} _service
     */
    function NgxImgComponent(_service) {
...
var NgxImgCropComponent = /** @class */ (function () {
     ...
     * @param {?} _service
     */
    function NgxImgCropComponent(_service) {
        this._service = _service;
        this.config = {};
...
//# sourceMappingURL=ngx-img.es5.js.map
